...
public interface TokenClient {
	...
	TokenDTO validateToken(@RequestHeader(name = "accessToken") String accessToken);
	
	@GetExchange("user")
	AuthUserResponse getAuthenticatedUser(@RequestHeader(name = "accessToken") String accessToken);
}
